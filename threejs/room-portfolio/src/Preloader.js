    ...
    return new Promise((resolve) => {
      ...
      this.secondTimeline
        .to(
          ...
          { yPercent: 100, stagger: 0.05, ease: "back.in(1.7)" },
          "fadeout",
        )
        ...
        .to(
          ...
          { x: 0.638711, y: 8.5618, z: 1.3243 },
          "same",
        )
        .set(this.roomChildren.body.scale, { x: 1, y: 1, z: 1 })
        .to(
        ...
        .to(
          ...
          { yPercent: 0, stagger: 0.07, ease: "back.out(1.7)" },
          "introtext",
        )
        .to(
        ...
        .to(
          ...
          { x: 1, y: 1, z: 1, ease: "back.out(2.2)", duration: 0.5 },
          ">-0.5",
        )
        .to(
        ...
        .to(
          ...
          { y: 4 * Math.PI + Math.PI / 4, ease: "power2.out", duration: 1 },
          "chair",
        )
