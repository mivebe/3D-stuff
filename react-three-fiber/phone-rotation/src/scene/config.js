...
export const SETTLE_QUAT = new THREE.Quaternion().setFromRotationMatrix(settleMatrix)

// start from a livelier 3/4 tilt, then square up to settle
const tilt = new THREE.Quaternion().setFromEuler(new THREE.Euler(-0.18, 0.8, 0.05))
