...
const SHOTS = {
  champagne: {
    quat: qAxis(1, 0, 0, 0.05)
      .multiply(qAxis(0, 1, 0, -0.38))
      .multiply(SETTLE_QUAT),
    finish: "champagne",
    phase: 5,
  },
  graphite: {
    quat: qAxis(1, 0, 0, 0.06)
      .multiply(qAxis(0, 1, 0, 0.42))
      .multiply(SETTLE_QUAT),
    finish: "graphite",
    phase: 5,
  },
  midnight: {
    quat: qAxis(1, 0, 0, 0.03)
      .multiply(qAxis(0, 1, 0, 0.2))
      .multiply(SETTLE_QUAT),
    finish: "midnight",
    phase: 5,
  },
