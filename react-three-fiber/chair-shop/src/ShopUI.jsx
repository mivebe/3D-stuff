...
export function Header({ goTo, cartCount, onOpenCart, compact }) {
  return (
    ...
    >
      <button
        style={{ ...styles.logo, ...styles.click }}
        onClick={() => goTo(0)}
      >
        CHAIR.
      </button>
      <nav style={styles.nav}>
        <button
          style={{ ...styles.orderBtn, ...styles.click }}
          onClick={onOpenCart}
        >
          order
    ...
    >
      ...
      <button
        style={{
          ...styles.addBtn,
          ...styles.click,
          ...(layout === "landscape" ? { marginTop: 12 } : null),
        }}
    ...
    <>
      ...
      >
        <div style={styles.drawerHead}>
          ...
          <button
            style={{ ...styles.closeBtn, ...styles.click }}
            onClick={onClose}
          >
            x
          </button>
        ...
        {items.length === 0 ? (
          <p style={styles.empty}>
            Your cart is empty. Add a Ritchie to get started.
          </p>
        ) : (
            ...
            {items.map((it) => (
              <div key={it.id} style={styles.item}>
                ...
                <div style={styles.qty}>
                  <button
                    style={{ ...styles.qtyBtn, ...styles.click }}
                    onClick={() => onDec(it.id)}
                  >
                    -
                  </button>
                ...
                <button
                  style={{ ...styles.removeBtn, ...styles.click }}
...
const styles = {
  ...
  hintArrow: {
    fontSize: 14,
    fontWeight: 800,
    animation: "chairBob 1.4s ease-in-out infinite",
  },
  toast: {
    position: "absolute",
    top: 74,
